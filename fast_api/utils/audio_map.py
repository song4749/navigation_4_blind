...
priority_order = {
    "Guide block detected again.": 1,
    "Stop sign detected! Please stop.": 2,
    "Pause at the stop block.": 2,
    "Pause and decide direction at stop block.": 2,
    "Turn Left.": 2,
    "Turn Right.": 2,
    "Road detected on the LEFT. Move right to stay on the sidewalk.": 0,
    "Road detected on the RIGHT. Move left to stay on the sidewalk.": 0,
